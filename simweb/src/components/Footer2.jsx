...
const Footer2 = () => {
  ...
  const Modal = ({ isOpen, onClose, title, children }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={onClose}>
        <div className="bg-gradient-to-b from-gray-900 via-black to-gray-900 border border-gray-700/50 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between p-6 border-b border-gray-700/50">
            <h2 className="text-2xl font-light text-white">{title}</h2>
            <button
              onClick={onClose}
              className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-800/50 hover:bg-red-500/20 border border-gray-600/50 hover:border-red-400/50 transition-all duration-300 group"
            >
  ...
  return (
    <div className="bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white px-8 py-20 font-sans overflow-hidden relative">
      {/* Background Animation Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-transparent rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-gradient-to-tr from-blue-400/8 to-transparent rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-cyan-500/8 to-blue-500/8 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>

      <div className="max-w-screen-xl mx-auto relative z-10">
        {/* Header Text */}
        <div className="text-center mb-20 animate-fade-in">
          <h2 className="text-5xl font-light mb-6 text-white tracking-wide">Get in Touch</h2>
          <p className="text-xl text-cyan-200 font-light max-w-2xl mx-auto leading-relaxed">
            We'd love to hear from you. Connect with us today and let's create something amazing together.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 mb-20">
          ...
          <div className="lg:col-span-2 space-y-8 animate-slide-in-left">
            <h3 className="text-2xl font-light text-white mb-8 pb-4 border-b border-gray-700/50">Contact Information</h3>
            
            <div className="space-y-6">
              <div className="group transform hover:scale-105 transition-all duration-300">
                <div className="flex items-start space-x-4 p-6 rounded-xl hover:bg-gray-800/30 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 border border-transparent hover:border-cyan-500/20 backdrop-blur-sm">
                  <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center group-hover:from-cyan-400 group-hover:to-blue-500 transition-all duration-300 shadow-lg shadow-cyan-500/20">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-cyan-300 uppercase tracking-wider">Address</span>
              ...
              <div className="group transform hover:scale-105 transition-all duration-300">
                <div className="flex items-start space-x-4 p-6 rounded-xl hover:bg-gray-800/30 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 border border-transparent hover:border-cyan-500/20 backdrop-blur-sm">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-cyan-300 uppercase tracking-wider">Phone</span>
                    <a href="tel:+917788003366" className="text-white hover:text-cyan-300 transition-colors duration-300 mt-2 block text-lg font-medium">
                      +91 77880 03366
                    </a>
                  </div>
                </div>
              ...
              <div className="group transform hover:scale-105 transition-all duration-300">
                <div className="flex items-start space-x-4 p-6 rounded-xl hover:bg-gray-800/30 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300 border border-transparent hover:border-cyan-500/20 backdrop-blur-sm">
                  ...
                  <div>
                    <span className="text-sm font-semibold text-cyan-300 uppercase tracking-wider">Email</span>
                    <a href="mailto:admin@sunnetwork.info" className="text-white hover:text-cyan-300 transition-colors duration-300 mt-2 block text-lg font-medium">
          ...
          <div className="lg:col-span-3 space-y-8 animate-slide-in-right">
            <h3 className="text-2xl font-light text-white mb-8 pb-4 border-b border-gray-700/50">Find Us</h3>
            <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-700/50 hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-700 transform hover:scale-[1.02]">
              <iframe
        ...
        <div className="relative my-16">
          ...
          <div className="relative flex justify-center">
            <div className="bg-gradient-to-r from-gray-900 to-black px-8">
              <div className="w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-600 rounded-full shadow-lg shadow-cyan-500/50"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-12 animate-fade-in-up">
          ...
          <div className="text-center lg:text-left space-y-4 flex-1">
            <div className="space-y-2">
              ...
              <p className="text-cyan-200 text-base font-light">
          ...
          <div className="flex flex-col items-center lg:items-end gap-6">
            <span className="text-cyan-200 text-base font-medium tracking-wide">Connect With Us</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="group w-14 h-14 bg-gray-800/50 border-2 border-gray-600/50 flex items-center justify-center rounded-full hover:border-cyan-400/70 hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-300 hover:-translate-y-2 hover:rotate-3 hover:bg-cyan-500/10 backdrop-blur-sm"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-14 h-14 bg-gray-800/50 border-2 border-gray-600/50 flex items-center justify-center rounded-full hover:border-green-400/70 hover:shadow-xl hover:shadow-green-500/20 transition-all duration-300 hover:-translate-y-2 hover:rotate-3 hover:bg-green-500/10 backdrop-blur-sm"
              ...
              <a
                ...
                className="group w-14 h-14 bg-gray-800/50 border-2 border-gray-600/50 flex items-center justify-center rounded-full hover:border-purple-400/70 hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-2 hover:rotate-3 hover:bg-purple-500/10 backdrop-blur-sm"
              ...
              <a
                ...
                className="group w-14 h-14 bg-gray-800/50 border-2 border-gray-600/50 flex items-center justify-center rounded-full hover:border-orange-400/70 hover:shadow-xl hover:shadow-orange-500/20 transition-all duration-300 hover:-translate-y-2 hover:rotate-3 hover:bg-orange-500/10 backdrop-blur-sm"
                title="Call us"
              >
      ...
      >
        <div className="space-y-6 text-gray-300 leading-relaxed">
          <p className="text-cyan-200 text-lg font-medium">Effective Date: {new Date().getFullYear()}</p>
      ...
      >
        <div className="space-y-6 text-gray-300 leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <p><strong className="text-cyan-300">Essential Cookies:</strong> These are necessary for the website to function properly and cannot be disabled.</p>
            <p><strong className="text-cyan-300">Analytics Cookies:</strong> We use these to understand how visitors interact with our website to improve our services.</p>
            <p><strong className="text-cyan-300">Functional Cookies:</strong> These enable enhanced functionality and personalization features.</p>
          </div>
