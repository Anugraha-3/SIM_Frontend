...
export default function HologramPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black via-black/80 to-transparent">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-4 mb-6 animate-fade-in-up">
              <div className="p-4 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-xl animate-pulse">
                {hologramData.icon}
              </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl animate-fade-in-up delay-200">
      ...
      <div 
        id="overview"
        className={`max-w-6xl mx-auto px-8 py-16 transition-all duration-1000 ${
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/5 rounded-2xl border border-white/10 p-8 backdrop-blur-md">
              <img
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-3xl font-bold mb-2">{hologramData.products[selectedProduct].name}</h3>
              <p className="text-gray-300 text-lg">{hologramData.products[selectedProduct].description}</p>
            </div>
            ...
            {hologramData.products[selectedProduct].applications && (
              <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-white/10">
                <h4 className="text-xl font-semibold mb-4">Applications</h4>
      ...
      <div 
        id="features"
        className={`bg-gradient-to-r from-purple-900/20 to-pink-900/20 py-16 transition-all duration-1000 ${
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index}
                className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-md hover:bg-white/10 transition-all duration-300 hover:scale-105 group"
              >
                <div className="mb-4 p-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg w-fit group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
      ...
      >
        <div className="text-center bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl border border-white/10 p-12">
  ...
  <button 
    ...
    className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 hover:scale-105"
  >
...
{showContactModal && (
  <div className="fixed inset-0 bg-black/70 backdrop-blur-lg flex items-center justify-center z-50 p-4 animate-fadeIn">
    <div className="bg-gradient-to-br from-gray-900/95 via-purple-900/20 to-pink-900/20 backdrop-blur-xl border border-purple-500/30 rounded-3xl p-8 max-w-5xl w-full relative overflow-hidden shadow-2xl shadow-purple-500/20">
      ...
      <button 
        ...
        className="absolute top-6 right-6 w-10 h-10 bg-white/10 border border-white/20 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/20 transition-all duration-300 hover:rotate-90 hover:scale-110 z-10 backdrop-blur-sm"
      >
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h3 className="text-4xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">
              Let's Connect
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <a 
            ...
            className="group relative flex flex-col items-center p-8 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl hover:border-blue-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-3 backdrop-blur-sm"
          >
            ...
            <div className="relative z-10 w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50">
              <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
            </div>
            <h4 className="font-bold text-lg mb-2 group-hover:text-blue-400 transition-colors duration-300">LinkedIn</h4>
            <p className="text-gray-400 text-sm text-center leading-relaxed">Connect with us professionally</p>
            <div className="absolute bottom-2 left-2 right-2 h-0.5 bg-gradient-to-r from-blue-500/0 via-blue-500/50 to-blue-500/0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
          </a>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex flex-col items-center p-8 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl hover:border-green-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-3 backdrop-blur-sm"
          >
            ...
            <div className="relative z-10 w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-3xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg shadow-green-500/30 group-hover:shadow-green-500/50">
              <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <h4 className="font-bold text-lg mb-2 group-hover:text-green-400 transition-colors duration-300">WhatsApp</h4>
            <p className="text-gray-400 text-sm text-center leading-relaxed">Quick chat & instant support</p>
            <div className="absolute bottom-2 left-2 right-2 h-0.5 bg-gradient-to-r from-green-500/0 via-green-500/50 to-green-500/0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
          </a>
          
          {/* Email */}
          <a 
            href="mailto:admin@sunnetwork.info"
            className="group relative flex flex-col items-center p-8 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl hover:border-purple-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-3 backdrop-blur-sm"
          >
            ...
            <div className="relative z-10 w-20 h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg shadow-purple-500/30 group-hover:shadow-purple-500/50">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 7.89a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h4 className="font-bold text-lg mb-2 group-hover:text-purple-400 transition-colors duration-300">Email</h4>
            <p className="text-gray-400 text-sm text-center leading-relaxed">Detailed inquiries & proposals</p>
            <div className="absolute bottom-2 left-2 right-2 h-0.5 bg-gradient-to-r from-purple-500/0 via-purple-500/50 to-purple-500/0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
          </a>
          
          {/* Phone */}
          <a 
            href="tel:917788003366"
            className="group relative flex flex-col items-center p-8 bg-gradient-to-br from-white/5 to-white/10 border border-white/10 rounded-2xl hover:border-orange-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-3 backdrop-blur-sm"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/0 to-orange-500/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="relative z-10 w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg shadow-orange-500/30 group-hover:shadow-orange-500/50">
              <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
            </div>
            <h4 className="font-bold text-lg mb-2 group-hover:text-orange-400 transition-colors duration-300">Call Direct</h4>
            <p className="text-gray-400 text-sm text-center leading-relaxed">Immediate assistance</p>
            <div className="absolute bottom-2 left-2 right-2 h-0.5 bg-gradient-to-r from-orange-500/0 via-orange-500/50 to-orange-500/0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
          </a>
        </div>
        ...
        <div className="text-center pt-6 border-t border-white/10">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            <span className="text-purple-400 font-semibold">Bulk orders welcome</span> • Custom pricing available • 
