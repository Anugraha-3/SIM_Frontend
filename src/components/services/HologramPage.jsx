    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <div className="relative h-[60vh] sm:h-[70vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          >
            <source src="/service/hologram_video.mp4" type="video/mp4" />
